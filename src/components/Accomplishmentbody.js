          ...
          <Col lg="10">
            <div className="allbodybg">
              {/* from header */}
                ...
                <div className={styles.bodytopheight}>
                  <div className={styles.bodyheaderleft} style={w<bp ? {width:'100%'} : {width:'50%'}}>
                    <FaClipboardList /> Plan VS Accomplishment
                  </div>
              ...
              <div className={styles.fromarea}>
                <span className={styles.bodyleftprogress} style={w<bp ? {fontSize:'15px'} : {fontSize:'22px'}}>
                  Fields </span>
                <span className={styles.bodycenterprogress} style={w<bp ? {width:'30%', fontSize:'15px'} : {width:'18%'}}>
                Planned </span>
                <span className={styles.bodycenterprogress}  style={w<bp ? {width:'30%', fontSize:'15px'} : {width:'18%'}}>
                  Accomp </span>
                  { w<bp ? (
                    ...
                    <span className={styles.bodyrightprogress}>Progress %</span>
                  )}
...
export default Ccomplishmentbody;
